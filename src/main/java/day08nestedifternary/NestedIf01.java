...
public class NestedIf01 {
    ...
    public static void main(String[] args) {
        ...
        //Kullanici negatif sayi girdi ise asagidaki gibi yazilabilir.
...
//        double c = Math.abs(input.nextDouble());
        ...
        //Kullanicin negatif sayi girmesini affetmiyorum diyorsaniz:
        if(a<=0 || b<=0 || c<=0){
            ...
            if(a==b && b==c && a==c){
                System.out.println("Ucgen hem de eskenar olanindan :)");
            }else{

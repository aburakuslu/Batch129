...
public class StringManipulations01 {
    ...
    public static void main(String[] args) {
        ...
        //Example 1: "s" String'indeki tum character'leri kucuk harf yapiniz.

        String sLower = s.toLowerCase();
        System.out.println(sLower); //java is easy

        //Example 1: "s" String'indeki ilk character'i aliniz.
        ...
        System.out.println(secondChar + secondLastChar); //212
        ...
        //Bir character'den baslayip String'in sonuna kadar almak istersiniz, ikinci index'i yazmayiniz.
        ...
        /*
            Bir method'u ogrenirken 3 sey mutlaka ogrenilmeli
            I) Bu method ne ise yarar?
           II) Bu method'un farkli kullanimlari nasildir?
          III) Bu method bize ne return eder?
         */
        ...
        //Example 11: "s" String'inin 6. characterden itibaren belli bir harfle baslayip baslamadigini
        // kontrol ediniz.

...
public class Exceptions02 {
    ...
    /*
        ...
        3)"throw"dan sonra "new" keyword ve "constructor" kullanilarak object olusturulur.
          "throws"dan sonra sadece Exception Class yazilir.
...
//        }
    ...
    //Exception Class constructor'inin icine istediginiz Exception Mesaji'ni yazabilirsiniz.
    ...
    public static void getMark(double d) {
        ...
        if (d < 0) {
            ...
            throw new IllegalArgumentException("Marks cannot be greater than a hundred");
        } else {

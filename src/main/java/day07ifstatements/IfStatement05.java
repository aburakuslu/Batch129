...
public class IfStatement05 {
    ...
    public static void main(String[] args) {
        ...
        /*
            Note: String'lerin esitliklerini kontrol ederken "==" yerine "equals()" kullanilir.
            Neden?
            Cunku; "==" sembolu iki String'i karsilastirirken hem adreslerine hem de degerlerine bakar.
            Ikisi de ayni ise String'ler esittir der, ancak biz kod yazarken genellikle String'lerin adres'leri
            degil degerleri ile ilgileniriz. Bu yuzden String karsilastirmalarinda "=="kullanilmaz.

...
public class Animal {
    ...
    Note 8: Chile --> Parent --> Grand Parent --> Great-Grand Parent ... seklinde ilerleyen inheritance'lara "Multi Level Inheritance" denir.
    ...
    Note 11: Java'da "parent"tan "child"a olan iliskilere "HAS-A Relationship" denir.

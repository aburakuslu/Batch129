...
public class ArrayLists01 {
    ...
    /*
        ...
        2) ArrayList(List)'ler non-primitive data tipindeki coklu data'lari depolamak icin kullanilir.
    ...
    public static void main(String[] args) {
        ...
        //add() method'u elemanlari sizin verdiginiz sirada (yani en sona) "list"e ekler. (Insertion Order)
        ages.add(9);
        ages.add(12);
        ages.add(10);
        ages.add(888);
        ...
        //List'e coklu eleman veya List'e baska bir List nasil eklenir?
        //Bir "List"e coklu eklemek icin, o elemanlari once bir List'in icine koymalisiniz.
        ...
        System.out.println(ages); //[9, 656, 8, 9, 10, 12, 777, 10, 8, 9, 10]
        ...
        //Bir elemanin List'te var olup olmadigini nasil kontrol edebiliriz?

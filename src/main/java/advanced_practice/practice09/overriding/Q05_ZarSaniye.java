...
public class Q05_ZarSaniye {
    ...
    // çift ise zar sayısı iki ile çarpılıp puana eklenecek, tek ise zar sayısı puana eklenecek.
    ...
    public static void zarAt() {
        ...
        if (sayac == 1) {
            ...
            if (puanBilgisayar < puanOyuncu) {
                System.out.println("Kazandiniz!!! " + puanOyuncu + " <==> " + puanBilgisayar);

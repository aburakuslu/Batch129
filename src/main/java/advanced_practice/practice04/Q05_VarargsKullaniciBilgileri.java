...
public class Q05_VarargsKullaniciBilgileri {
    //Ad, soyad, yaş ve bugüne dek yaşanılmış
    // sehirler bilgilerini parametre olarak alıp yazdıran bir method oluşturunuz.

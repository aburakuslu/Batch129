...
public class Arrays05 {
    ...
    public static void main(String[] args) {
        ...
        //Note 2: sort() method'u String'i alfabetik olarak siralar(alphabetical order)
        ...
        int num3 = Arrays.binarySearch(colors, "Tarik");// -6 ==> "-" bu eleman yok demek
        System.out.println(num3);                            //        "6" ise olsaydi 6. eleman olurdu demek.
    }
}

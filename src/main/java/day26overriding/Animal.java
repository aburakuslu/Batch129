package day26overriding;
    /*
        ...
        8)Method'un return type'i "primitive" ise Overriding yaparken return type degistirilemez. Cunku; return type ya ayni olur
          veya parent'tan secilir ama primitive'ler arasinda parent-child iliskisi olmadigindan parent'tan secmek mevzubahis olamaz.
          O zaman tek secenek "aynisi olmalidir" kalir.
        9)Method'un return type'i "Wrapper Class" ise, Overriding yaparken return type degistirilemez. Cunku; return type ya
          ayni olur veya parent'dan secilir, ama Java bir wrapper class'i digerinin parent'i yapmadigindan parent'dan secme
          ihtimali yoktur, geriye sadece aynisi olma ihtimali kalir.
